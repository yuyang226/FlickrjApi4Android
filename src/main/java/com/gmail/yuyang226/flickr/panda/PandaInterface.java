...
public class PandaInterface {
     ...
     * the {@link com.gmail.yuyang226.flickr.panda.PandaInterface#getPhotos(Panda, Set, int, int)}
     * API method.
     *
     ...
     * @param extras A set of Strings controlling the extra information to fetch for each returned record. {@link com.gmail.yuyang226.flickr.photos.Extras#ALL_EXTRAS}
