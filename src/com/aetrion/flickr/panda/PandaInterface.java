...
public class PandaInterface {
     ...
     * @throws SAXException
     */
    public List<Panda> getList() throws FlickrException, IOException, SAXException {
     ...
     */
    public PhotoList getPhotos(Panda panda, Set<String> extras, int perPage, int page) throws FlickrException, IOException, SAXException {
        //List<Panda> pandas = new ArrayList<Panda>();
        List<Parameter> parameters = new ArrayList<Parameter>();
