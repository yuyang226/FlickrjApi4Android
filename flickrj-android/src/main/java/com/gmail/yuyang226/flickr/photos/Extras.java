...
public class Extras {
     ...
     *
     * @see com.gmail.yuyang226.flickr.groups.pools.PoolsInterface#getPhotos(String, String[], Set, int, int)
     * @see com.gmail.yuyang226.flickr.panda.PandaInterface#getPhotos(com.gmail.yuyang226.flickr.panda.Panda, Set, int, int)
     * @see com.gmail.yuyang226.flickr.people.PeopleInterface#getPublicPhotos(String, Set, int, int)
     * @see com.gmail.yuyang226.flickr.photosets.PhotosetsInterface#getPhotos(String, Set, int, int, int)
     * @see com.gmail.yuyang226.flickr.photos.PhotosInterface#getContactsPublicPhotos(String, Set, int, boolean, boolean, boolean)
     * @see com.gmail.yuyang226.flickr.photos.PhotosInterface#getWithGeoData(java.util.Date, java.util.Date, java.util.Date, java.util.Date, int, String, Set, int, int)
     * @see com.gmail.yuyang226.flickr.photos.PhotosInterface#getWithoutGeoData(java.util.Date, java.util.Date, java.util.Date, java.util.Date, int, String, Set, int, int)
     * @see com.gmail.yuyang226.flickr.photos.PhotosInterface#recentlyUpdated(java.util.Date, Set, int, int)
     * @see com.gmail.yuyang226.flickr.photos.SearchParameters#setExtras(Set)
     * @see com.gmail.yuyang226.flickr.photos.geo.GeoInterface#photosForLocation(GeoData, Set, int, int)
     * @see com.gmail.yuyang226.flickr.interestingness.InterestingnessInterface#getList(java.util.Date, Set, int, int)
     * @see com.gmail.yuyang226.flickr.favorites.FavoritesInterface#getList(String, int, int, Set)
     */
